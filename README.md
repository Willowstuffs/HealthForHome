...
Projekt obejmował stworzenie systemu umożliwiającego:
    ...
    zarządzanie specjalistami i usługami,

    obsługę wizyt domowych,

    administrację użytkownikami i danymi,
...
Projekt został zakończony i zarchiwizowany.
    ...
    Repozytorium zawiera finalny kod backendu oraz panelu administracyjnego

    Brak aktywnego środowiska produkcyjnego
