...
namespace H4H.Data.Migrations.Manual
{
    ...
    [Migration("20260321162959_AddLicenseValidUntilToSpecialistQualifications")]
    partial class AddLicenseValidUntilToSpecialistQualifications
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("H4H.Core.Models.AppointmentSpecialist", b =>
                {
                    ...
                    b.Property<List<Guid>>("ServiceTypeIds")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid[]")
                        .HasColumnName("service_type_ids")
                        .HasDefaultValueSql("'{}'");
